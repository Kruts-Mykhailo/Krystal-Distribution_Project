package be.kdg.prog6.adapters.out.db.orderLine;



import be.kdg.prog6.adapters.out.db.purchaseOrder.PurchaseOrderJpaEntity;
...
@Setter
@Entity
@Table(name = "order_lines", catalog = "waterside")
